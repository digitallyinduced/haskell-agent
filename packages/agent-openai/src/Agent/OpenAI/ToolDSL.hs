...
-- Mirrors the shape used by the IHP OpenAI helpers but keeps this package
-- IHP-free. Use 'PropertyRaw' to inject a custom schema fragment.
data PropertyType
    = PropertyString
    | PropertyInteger
    | PropertyNumber
