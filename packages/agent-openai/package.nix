...
, safe-exceptions, scientific, stm, template-haskell, temporary
, text, time, transformers, unix, vector, wai, warp, websockets
, wuss
}:
mkDerivation {
  pname = "agent-openai";
  ...
  libraryHaskellDepends = [
    ...
    io-streams network-uri retry safe-exceptions scientific stm
  ...
  testHaskellDepends = [
    ...
    filepath hspec http-types io-streams network retry safe-exceptions
