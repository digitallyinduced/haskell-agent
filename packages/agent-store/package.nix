...
, crypton, directory, filelock, filepath, hasql, hasql-pool
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    async base bytestring containers contravariant crypton directory
    filelock filepath hasql hasql-pool hasql-transaction pqi-ffi
