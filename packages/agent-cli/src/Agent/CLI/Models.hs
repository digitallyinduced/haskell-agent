...
modelsForProvider provider =
    let opts = case provider of
            ...
            ClaudeCodeProvider ->
                [ opt "sonnet" ClaudeCodeDialect
                    (Just "default · subscription")
                , opt "opus" ClaudeCodeDialect
                    (Just "frontier · subscription")
                , opt "fable" ClaudeCodeDialect
                    (Just "fast · subscription")
                ]
