...
, resourcet, retry, safe-exceptions, scientific, stm, tagsoup
, temporary, terminfo, text, time, tls, transformers, unix, vector
, vty, vty-crossplatform, vty-unix, wai, warp
}:
mkDerivation {
  pname = "agent-cli";
  version = "0.1.0.0";
