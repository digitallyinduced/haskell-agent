...
, agent-json-hermes, agent-responses-types, base, base64-bytestring
, bytestring, containers, hermes-json, hspec, http-client
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    agent-core agent-json-codec agent-json-hermes agent-responses-types
    base base64-bytestring bytestring containers hermes-json
  ...
  benchmarkHaskellDepends = [
    aeson agent-core agent-json-codec agent-json-hermes
    agent-responses-types base bytestring text
  ];
