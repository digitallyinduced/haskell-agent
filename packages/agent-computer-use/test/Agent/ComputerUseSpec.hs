module Agent.ComputerUseSpec (spec) where
...
import Agent.ComputerUse.Backend
    ( CapturedDisplay(..)
    , ComputerBackend(..)
    , ComputerDisplay(..)
    )
import Agent.ComputerUse.Linux
    ( LinuxSessionType(..)
    , detectLinuxSessionType
    )
import Agent.ComputerUse.Linux.Logind
    ( LogindSessionTarget(..)
    , WaylandPortalTarget(..)
...
import Agent.ComputerUse.Input (MouseButton(..))
import Agent.ComputerUse.Linux.Portal
    ( CapturedPortalFrame(..)
    , PortalBackendState(..)
    , PortalFrameState(..)
    , PortalPngFrame(..)
...
import Agent.ComputerUse.Linux.X11
    ( XdotoolInvocation(..)
    , parseXrandrDisplay
