{ mkDerivation, aeson, agent-core, agent-responses, base, bytestring
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    aeson agent-core agent-responses base bytestring http-client http-client-tls
    http-conduit http-types retry safe-exceptions scientific text time
  ];
  testHaskellDepends = [
    aeson agent-core agent-responses base bytestring case-insensitive
