...
module Agent.Runtime.Session.Codec
    ( contentFingerprint
    , loadTranscript
    , decodeFileEither
    , decodeStoredSession
...
import Agent.Runtime.Session.Types
...
toStoredMetadata meta = Store.SessionMetadata
    ...
    , sessionMetadataGatewayIdentity = meta.metaGatewayIdentity
...
fromStoredMetadata stored = do
    ...
    pure SessionMeta
        ...
        , metaGatewayIdentity = stored.sessionMetadataGatewayIdentity
