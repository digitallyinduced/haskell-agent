    ...
    Text.unlines $
        ...
        , "Use the registered tools:"
            ...
            <> toolLine "update_plan"
                "- For every multi-step task, call update_plan before starting and keep it current throughout. Mark steps completed after verification; before the final response, complete or explicitly cancel every remaining step."
            <> toolLine "run_ghci"
