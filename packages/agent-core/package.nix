...
, containers, crypton, crypton-connection, directory, filelock
, filepath, hspec, lib, process, QuickCheck, resourcet, retry
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    base64-bytestring bytestring containers crypton crypton-connection
    directory filelock filepath process resourcet retry safe-exceptions
    stm template-haskell text time tls transformers unix vector
    websockets yaml
  ];
  testHaskellDepends = [
