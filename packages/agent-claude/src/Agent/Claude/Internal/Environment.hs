module Agent.Claude.Internal.Environment
...
--
-- The allow-list check performed by 'Agent.Claude.Auth' remains the
...
anthropicEnvironmentVariables =
    ...
    , "HASKELL_AGENT_GATEWAY_URL"
    , "HASKELL_AGENT_GATEWAY_TOKEN"
    ]
